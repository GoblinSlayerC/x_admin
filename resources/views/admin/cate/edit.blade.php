        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_username" name="name" required="" value="{{$cate->name}}" autocomplete="off" class="layui-input" placeholder=""></div>
            </div>
                ...
                <div class="layui-input-inline">
                    <select name="pid" lay-filter="aihao">
                        ...
                        @foreach($cate_list as $val)
                            <option value="{{$val->cid}}" {{$cate->pid == $val->cid? 'selected':''}}>{{str_repeat('--', $val->level)}} {{$val->name}}</option>
                        @endforeach
                    </select></div>
            </div>
            <div class="layui-form-item">
                <label for="L_repass" class="layui-form-label"></label>
                <button class="layui-btn" lay-filter="edit" lay-submit="">编辑分类</button></div>
        </form>
    </div>
</div>
